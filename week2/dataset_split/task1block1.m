function [ Sign_characteristics, Text_files ] = task1block1( directory_read, directory_write )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Folder_gt = strcat(directory_read, '/gt');
...
for i = 1:length(Text_files)
    ...
    mask = double(imread(strcat(directory_read, '/mask/mask.', Sign_characteristics{ii+1,1}, '.png')));
...
save(strcat(directory_write, '/characteristics_signs'), 'Sign_characteristics');
end