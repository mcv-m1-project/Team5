function [ metrix_method ] = SignDetectionUCM( params, files, SC_train )
...
UCM(params, files, SC_train );


path = params.directory_write_results;
directory = params.directory_read_images;
if params.compute_metrics
    %When the images are computed, if the set is not the test set, we compute
