function [ metrix_method ] = SignDetectionDistTransformGlobal( params, files)
...
switch params.colorSpace
    case 1
        ...
        params.directory_write_results = strcat(params.directory_write_results, '/HSV_DT_Global/');
    ...
    case 2
        ...
        %Directory to write results
        params.directory_write_results = strcat(params.directory_write_results, '/HSV&RGB_DT_Global/');
...
Distance_transformGlobal(params, files);
