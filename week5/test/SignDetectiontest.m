function [ metrix_method ] = SignDetectiontest(params, files,threshold,circleradius)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
average_time = Task3block1test(path_images, List_of_images, params.directory_write_results, pixel_method,threshold,circleradius);
